//! LZMA/Lzip encoding and decoding streams
//!
//! This library is a binding to lzlib currently to provide LZMA and lzip
...
//!
//! ```toml
//! lzip = { version = "0.1.6", features = ["tokio"] }
//! ```
//!
...
#![deny(missing_docs)]
#![doc(html_root_url = "https://docs.rs/lzip/0.1")]
